          ...
          >
            ...
            <div className="glass-card p-8">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/developer-amarjeetBaraik/" target='_blank' className="w-10 h-10 rounded-full bg-navy-dark/50 flex items-center justify-center text-gray-300 hover:text-white hover:bg-navy/50 transition-colors">
                ...
                <a href="https://linkedin.com/in/amarjeet-chik-baraik" target='_blank' className="w-10 h-10 rounded-full bg-navy-dark/50 flex items-center justify-center text-gray-300 hover:text-white hover:bg-navy/50 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                  </svg>
                </a>
                <a href="https://x.com/Amarjeet_c_b" target='_blank' className="w-10 h-10 rounded-full bg-navy-dark/50 flex items-center justify-center text-gray-300 hover:text-white hover:bg-navy/50 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                ...
                <a href="https://www.instagram.com/amarjeet_baraik_/" target='_blank' className="w-10 h-10 rounded-full bg-navy-dark/50 flex items-center justify-center text-gray-300 hover:text-white hover:bg-navy/50 transition-colors">
